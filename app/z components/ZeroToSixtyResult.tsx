        ...
        < >
            {T1 > T2 ? 
                (<div > 
                    ...
                    <input  value={secondsFasterMessage}disabled className="mb-3  bg-gradient-to-r from-amber-50 to-yellow-200 rounded-lg h-8 border-none text-center font-bold text-lg   text-green-600 w-11/12"/>  
                </div>) 
                : 
                (<div > 
                    ...
                    <input  value={secondsSlowerMessage} disabled className=' mb-3  bg-gradient-to-r from-yellow-300 to-amber-600 rounded-lg h-8 border-none text-center font-bold text-lg  text-orange-700 w-11/12'/> 
                </div>)
            }
