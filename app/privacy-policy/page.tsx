...
<h2 >Privacy Policy</h2>
    ...
    <br></br>
    <p>This policy is effective as of 15 May 2022 and was last updated on 01 September 2023.</p>
    <br></br>
    ...
    <ul >
        <li><p>  Name</p></li>
        <li><p  >Email</p></li>
        <li><p  >Phone/mobile number</p></li>
        <li><p  >Home/mailing address</p></li>
    </ul>
    <br></br>
        ...
        <ul >
            <li><p  >Enter any of our competitions, contests, sweepstakes, and surveys</p></li>
            <li><p  >Sign up to receive updates from us via email or social media channels</p></li>
            ...
            <p  >We may collect, hold, use, and disclose information for the following purposes, and personal information will not be further processed in a manner that is incompatible with these purposes:</p><ul ><li><p  >to contact and communicate with you</p></li>
            <li><p  >for analytics, market research, and business development, including to operate and improve our website, associated applications, and associated social media platforms</p></li>
            <li><p  >for advertising and marketing, including to send you promotional information about our products and services and information about third parties that we consider may be of interest to you</p></li><li><p  >for internal record keeping and administrative purposes</p></li>
            <li><p  >to run competitions, sweepstakes, and/or offer additional benefits to you</p></li>
            <li><p  >for security and fraud prevention, and to ensure that our sites and apps are safe, secure, and used in line with our terms of use</p></li>
        </ul>
            ...
            <ul >
                <li><p  >a parent, subsidiary, or affiliate of our company</p></li>
                <li><p  >third party service providers for the purpose of enabling them to provide their services, for example, IT service providers, data storage, hosting and server providers, advertisers, or analytics platforms</p></li>
                <li><p  >our employees, contractors, and/or related entities</p></li>
                <li><p  >our existing or potential agents or business partners</p></li>
                <li><p  >sponsors or promoters of any competition, sweepstakes, or promotion we run</p></li>
                <li><p  >courts, tribunals, regulatory authorities, and law enforcement officers, as required by law, in connection with any actual or prospective legal proceedings, or in order to establish, exercise, or defend our legal rights</p></li>
                <li><p  >third parties, including agents or sub-contractors, who assist us in providing information, products, services, or direct marketing to you third parties to collect and process data</p></li>
            </ul
            >
            <br></br>
            ...
            <p  >If we receive personal information about you from a third party, we will protect it as set out in this privacy policy. If you are a third party providing personal information about somebody else, you represent and warrant that you have such person’s consent to provide the personal information to us.</p><p  >If you have previously agreed to us using your personal information for direct marketing purposes, you may change your mind at any time. We will provide you with the ability to unsubscribe from our email-database or opt out of communications. Please be aware we may need to request specific information from you to help us confirm your identity.</p>
            ...
            <br></br>
            <h3 >Contact Us</h3>
            <p  >For any questions or concerns regarding your privacy, you may contact us at the Contact page of our website: <a href="/contact">www.calculatedcustoms.com/contact</a></p>
        </div>
    )
}