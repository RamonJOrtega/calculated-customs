...
export default function PrivacyPolicyPage() {
  return (
    <div className={inter.className}>
      ...
      <p>
        Your privacy is important to us. It is Calculated Customs LLC's policy to
        ...
        our website,{' '}
        <a href="https://calculatedcustoms.com/">
          {' '}
          <span>https://calculatedcustoms.com</span>
        </a>
        , and other sites we own and operate.
      </p>
      <br></br>
      <p>
        This policy is effective as of 15 May 2022 and was last updated on 01
        September 2023.
      </p>
      <br></br>
      ...
      <p>
        ...
        to us, we advise that no method of electronic transmission or storage is 100%
      ...
      <p>
        ...
        with this privacy policy. If your personal information is no longer required,
        we will delete it or make it anonymous by removing all details that identify
        you.
      </p>
      ...
      <p>
        ...
        personal information to third parties in other countries: (i) we will perform
        those transfers in accordance with the requirements of applicable law; and
        (ii) we will protect the transferred personal information in accordance with
        this privacy policy.
      </p>
      <br></br>
      ...
      <p>
        ...
        that you have such person’s consent to provide the personal information to
        us.
      </p>
      <p>
      ...
      <p>
        ...
        investigation and the steps we will take to deal with your complaint. You
        also have the right to contact a regulatory body or data protection authority
      ...
      <p>
        ...
        business processes, current acceptable practices, or legislative or
      ...
      <p>
        ...
        <a href="/contact">www.calculatedcustoms.com/contact</a>
      </p>
    </div>
  );
}
