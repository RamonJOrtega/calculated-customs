        ...
        <div >
            <div className = 'mx-2 w-9/10 w-max-282'>
                ...
                <p>
                    ...
                    These terms and conditions outline the rules and regulations for the use of Calculated Customs LLC's Website, located at https://www.calculatedcustoms.com/.
                </p>
                <p>
                ...
                <p>
                    Republish material from Calculated Customs.
                </p>
                </li><li>
                <p>
                    Sell, rent or sub-license material from Calculated Customs

                </p>
                </li><li>
                <p>
                    Reproduce, duplicate or copy material from Calculated Customs
                </p>
                </li><li>
                <p>
                    Redistribute content from Calculated Customs
                </p>
                </li><li>
                <p>
                ...
                <p>
                    ...
                    Calculated Customs LLC does not filter, edit, publish or review Comments prior to their presence on the website. 
                    Comments do not reflect the views and opinions of Calculated Customs LLC, its agents and/or affiliates. 
                    Comments reflect the views and opinions of the person who post their views and opinions. 
                    To the extent permitted by applicable laws, Calculated Customs LLC shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
                    </p>
                <p>
                    Calculated Customs LLC reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.
                </p>
                <p>
                    You warrant and represent that:
                </p>
                <ul data-rte-list="default"><li><p>
                    ...
                    You hereby grant Calculated Customs LLC a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.
                </p>
                <h3 >
                <br></br>
