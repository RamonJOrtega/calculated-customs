  ...
  return (
    <div>
      <div className="mx-2 w-9/10 w-max-282">
        ...
        <p>
          Welcome to Calculated Customs! These terms and conditions outline the rules
          and regulations for the use of Calculated Customs LLC's Website, located at
          https://www.calculatedcustoms.com/.
        </p>
        <p>
          By accessing this website we assume you accept these terms and conditions.
          Do not continue to use Calculated Customs if you do not agree to take all
        ...
        <p>
          Our Calculators internal parameters are proprietary. Calculated Customs LLC
          claims no liability for inaccuracy of online calculators. The Calculators,
          although meticulously created through real-world empirical experimentation,
          provide estimates only.
        </p>
        <h3>
          <br></br>
        ...
        <p>
          Though we do not employ the use of cookies currently, we reserve the right
          to employ them in the future. By accessing Calculated Customs, you agreed
          to use cookies in agreement with the Calculated Customs LLC Privacy Policy.
        </p>
        <p>
        ...
        <p>
          Unless otherwise stated, Calculated Customs LLC and/or its licensors own
          the intellectual property rights for all material on Calculated Customs.
          All intellectual property rights are reserved. You may access this from
          Calculated Customs for your own personal use subjected to restrictions set
          in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul data-rte-list="default">
          <li>
            <p>Republish material from Calculated Customs.</p>
          </li>
          <li>
            <p>Sell, rent or sub-license material from Calculated Customs</p>
          </li>
          <li>
            <p>Reproduce, duplicate or copy material from Calculated Customs</p>
          </li>
          <li>
            <p>Redistribute content from Calculated Customs</p>
          </li>
          <li>
            <p>
              Use the Calculators on calculatedcustoms.com outside of calculated.com
            </p>
          </li>
        </ul>
        ...
        <p>
          ...
          opinions and information in certain areas of the website. Calculated
          Customs LLC does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Calculated Customs LLC, its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Calculated Customs
          LLC shall not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or posting of
          and/or appearance of the Comments on this website.
        </p>
        <p>
          Calculated Customs LLC reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant Calculated Customs LLC a non-exclusive license to use,
